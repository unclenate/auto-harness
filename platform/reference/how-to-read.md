...
The harness documentation is large — 50 modules, 95 templates, 20 validators, 8 skills, 23 workflows —
...
```text
                    ...
                    │   (50 modules)       │  readable governance declaration.
