...
| ---------- | ---- | ----- | ------ | ----------------- | ----- |
| Ruby (>= 3.0) | Infra | @unclenate | Resolved | Validators cannot run | Required by all 8 validators and test suite; CI pins 3.3 (matches `CONTRIBUTING.md`, `platform/validators/README.md`, `.github/workflows/harness.yml`) |
