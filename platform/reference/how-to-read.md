...
The harness documentation is large — 47 modules, 89 templates, 18 validators, 8 skills, 21 workflows —
...
```text
                    ...
                    │   (47 modules)       │  readable governance declaration.
