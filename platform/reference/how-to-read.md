...
The harness documentation is large — 48 modules, 92 templates, 20 validators, 8 skills, 23 workflows —
...
```text
                    ...
                    │   (48 modules)       │  readable governance declaration.
