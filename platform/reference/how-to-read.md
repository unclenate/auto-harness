...
The harness documentation is large — 49 modules, 94 templates, 20 validators, 8 skills, 23 workflows —
...
```text
                    ...
                    │   (49 modules)       │  readable governance declaration.
