...
The harness documentation is large — 51 modules, 96 templates, 20 validators, 8 skills, 23 workflows —
...
```text
                    ...
                    │   (51 modules)       │  readable governance declaration.
