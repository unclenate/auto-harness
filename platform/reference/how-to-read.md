...
The harness documentation is large — 54 modules, 98 templates, 27 validators, 8 skills, 24 workflows —
...
```text
                    ...
                    │   (54 modules)       │  readable governance declaration.
