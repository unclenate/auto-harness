...
ls development-harness/platform/
...
```bash
# Install the skill
cp -r development-harness/platform/skills/harness-onboarding .claude/skills/
...
cp -r development-harness/platform/skills/harness-onboarding .agents/skills/
```
...
```bash
cp development-harness/platform/compositions/brownfield-lite.yaml harness.manifest.yaml
...
```bash
cat development-harness/platform/examples/sample-projects/node-web-saas-postgres/HARNESS.md
cat development-harness/platform/examples/sample-projects/node-web-saas-postgres/AGENTS.md
cat development-harness/platform/examples/sample-projects/node-web-saas-postgres/docs/operating-principles.md
```
...
cp development-harness/platform/templates/architecture-overview.md docs/architecture/overview.md

# Create the problem statement
mkdir -p docs/product
cp development-harness/platform/templates/product/problem-statement.md docs/product/problem-statement.md
```
